...
import 'package:colortaxi/model/user_model.dart';
import 'package:colortaxi/page/auth_screens/login_screen.dart';
import 'package:colortaxi/page/contact_us/contact_us_screen.dart';
import 'package:colortaxi/page/coupon_code/coupon_code_screen.dart';
import 'package:colortaxi/page/dash_board.dart';
import 'package:colortaxi/page/favotite_ride_screens/favorite_ride_screen.dart';
import 'package:colortaxi/page/localization_screens/localization_screen.dart';
import 'package:colortaxi/page/my_profile/my_profile_screen.dart';
import 'package:colortaxi/page/new_ride_screens/new_ride_screen.dart';
import 'package:colortaxi/page/privacy_policy/privacy_policy_screen.dart';
import 'package:colortaxi/page/referral_screen/referral_screen.dart';
import 'package:colortaxi/page/rent_vehicle_screens/rent_vehicle_screen.dart';
import 'package:colortaxi/page/rented_vehicle.dart';
import 'package:colortaxi/page/terms_service/terms_of_service_screen.dart';
import 'package:colortaxi/page/wallet/wallet_screen.dart';
...
class DashBoardController extends GetxController {
  ...
  onSelectItem(int index) {
    if (index == 13) {
      LaunchReview.launch(
        androidAppId: "com.colortaxi",
        iOSAppId: "com.colortaxi.ios",
      );
    } else if (index == 14) {
