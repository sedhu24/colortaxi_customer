...
import 'package:colortaxi/model/payment_setting_model.dart';
import 'package:colortaxi/model/tax_model.dart';
import 'package:colortaxi/model/user_model.dart';
import 'package:colortaxi/page/chats_screen/conversation_screen.dart';
...
class Constant {
  static String? kGoogleApiKey = "AIzaSyBLmFR2N52rYflO8KuNNzlDJSqtIfG2YK0";
  static String? distanceUnit = "KM";
  static String? appVersion = "0.0";
  static String? decimal = "2";
  static String? currency = "\u{20B9}";
  ...
  static Widget loader() {
    return Center(
      child: CircularProgressIndicator(color: ConstantColors.yellow),
    );
  }
