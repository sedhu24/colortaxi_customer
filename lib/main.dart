...
import 'package:colortaxi/controller/settings_controller.dart';
...
class MyApp extends StatelessWidget {
  ...
  Future<void> setupInteractedMessage(BuildContext context) async {
    ...
    await FirebaseMessaging.instance.subscribeToTopic("colortaxi");
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GetMaterialApp(
      ...
      theme: ThemeData(
        primaryColor: ConstantColors.yellow,
