...
import 'package:colortaxi/controller/phone_number_controller.dart';
import 'package:colortaxi/page/auth_screens/add_profile_photo_screen.dart';
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: PinCodeTextField(
                            ...
                            cursorColor: ConstantColors.yellow,
                        ...
                        Padding(
                            ...
                            child: ButtonThem.buildButton(
                              ...
                              onPress: () async {
                                        ...
                                        await controller
                                          ...
                                          if (value != null) {
                                            if (value.success == "success") {
                                              ...
                                              //
                                              //
                                              log("access Token ==> 151 ${value.data!.accesstoken}");
                                              log("access Token ==> 152 ${value.data!.id}");
                                              Preferences.setString(
                                ...
                                Map<String, String> bodyParamstest = {
                                  'phone': phoneNumber.toString(),
                                  'user_cat': "customer",
                                };
                              },
