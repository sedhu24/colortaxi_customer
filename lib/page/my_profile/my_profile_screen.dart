...
import 'package:colortaxi/controller/dash_board_controller.dart';
import 'package:colortaxi/controller/my_profile_controller.dart';
...
import 'package:colortaxi/themes/responsive.dart';
import 'package:colortaxi/themes/text_field_them.dart';
                              ...
                              Center(
                                child: ClipRRect(
                                  ...
                                  child: myProfileController.photoPath.isEmpty
                                      ? CachedNetworkImage(
                                          imageUrl:
                                              "https://colortaxi.siswebapp.com/assets/images/placeholder_image.jpg",
                                          height: 120,
                                          width: 120,
                                          fit: BoxFit.cover,
          ...
          leading: Column(
            ...
            children: [
              Padding(
                ...
                child: Container(
                    decoration: BoxDecoration(
                        color: ConstantColors.yellow.withOpacity(0.08),
                        borderRadius:
